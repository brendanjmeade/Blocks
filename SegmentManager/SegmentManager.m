...
Seg.loadEdit                     = uicontrol('style', 'edit',           'position', [10 710+segmentYOffset 280 20],   'visible', 'on', 'tag', 'Seg.loadEdit', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'left', 'Fontsize', 8);
...
Seg.modGSelectM                  = uicontrol('style', 'pushbutton',     'position', [80 595+20+segmentYOffset 70 20],   'visible', 'on', 'tag', 'Seg.modGSelectBox', 'callback', 'SegmentManagerFunctions(''Seg.modGSelectBox'')','string', 'GSelectBox', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'center', 'FontName', fn, 'FontSize', fs);
...
Seg.modDeletePush                = uicontrol('style', 'pushbutton',     'position', [10 575+20+segmentYOffset 70 20],   'visible', 'on', 'tag', 'Seg.modDeletePush', 'callback', 'SegmentManagerFunctions(''Seg.modDeletePush'')','string', 'GDelete', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'center', 'FontName', fn, 'FontSize', fs);
...
Seg.loadEditBlock                = uicontrol('style', 'edit',           'position', [10 490+blockYOffset 280 20],   'visible', 'on', 'tag', 'Seg.loadEditBlock', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'left', 'Fontsize', 8, 'FontName', fn, 'FontSize', fs);
...
Seg.modDeleteBlock                = uicontrol('style', 'pushbutton',     'position', [10 575-200+blockYOffset 70 20],   'visible', 'on', 'tag', 'Seg.modDeleteBlock', 'callback', 'SegmentManagerFunctions(''Seg.modDeleteBlock'')','string', 'GDelete', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'center', 'FontName', fn, 'FontSize', fs);
...
Seg.modGSelectBlockBox            = uicontrol('style', 'pushbutton',     'position', [80 595-200+blockYOffset 70 20],  'visible', 'on', 'tag', 'Seg.modGSelectBlockBox', 'callback', 'SegmentManagerFunctions(''Seg.modGSelectBlockBox'')','string', 'GSelectBox', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'center', 'FontName', fn, 'FontSize', fs);
...
Seg.loadEditMesh              = uicontrol('style', 'edit',           'position', [10 710+meshYOffset 280 20],   'visible', 'on', 'tag', 'Seg.loadEditMesh', 'BackgroundColor', lightGrey, 'HorizontalAlignment', 'left', 'Fontsize', 8);
...
Seg.dispTopo                     = uicontrol('style', 'checkbox', 'position', [195 135+dispYOffset 100 20],    'visible', 'on', 'tag', 'Seg.dispTopo', 'callback', 'SegmentManagerFunctions(''Seg.dispTopo'')', 'string', {'Topo'}, 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs);
Seg.dispGrid                     = uicontrol('style', 'checkbox', 'position', [195 115+dispYOffset 100 20],    'visible', 'on', 'tag', 'Seg.dispGrid', 'callback', 'SegmentManagerFunctions(''Seg.dispGrid'')', 'string', {'Grid'}, 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs);
Seg.dispDips                     = uicontrol('style', 'checkbox', 'position', [195 95+dispYOffset 100 20],     'visible', 'on', 'tag', 'Seg.dispDips', 'callback', 'SegmentManagerFunctions(''Seg.dispDips'')', 'string', {'Dips'}, 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs);
