...
Rst.StatCheck          	         = uicontrol('style', 'checkbox',       'position', [10 165+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.StatCheck', 'callback', 'ResultManagerFunctions(''Rst.StatCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.StanCheck          	         = uicontrol('style', 'checkbox',       'position', [10 145+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.StanCheck', 'callback', 'ResultManagerFunctions(''Rst.StanCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.ObsvCheck           	      = uicontrol('style', 'checkbox',       'position', [10 125+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.ObsvCheck', 'callback', 'ResultManagerFunctions(''Rst.ObsvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.ModvCheck                  	= uicontrol('style', 'checkbox',       'position', [10 105+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.ModvCheck', 'callback', 'ResultManagerFunctions(''Rst.ModvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.ResvCheck                  	= uicontrol('style', 'checkbox',       'position', [10  85+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.ResvCheck', 'callback', 'ResultManagerFunctions(''Rst.ResvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.RotvCheck                  	= uicontrol('style', 'checkbox',       'position', [10  65+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.RotvCheck', 'callback', 'ResultManagerFunctions(''Rst.RotvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.DefvCheck                  	= uicontrol('style', 'checkbox',       'position', [10  45+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.DefvCheck', 'callback', 'ResultManagerFunctions(''Rst.DefvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.StrvCheck                  	= uicontrol('style', 'checkbox',       'position', [10  25+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.StrvCheck', 'callback', 'ResultManagerFunctions(''Rst.StrvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.TrivCheck                  	= uicontrol('style', 'checkbox',       'position', [10   5+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.TrivCheck', 'callback', 'ResultManagerFunctions(''Rst.TrivCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.ResmCheck                  	= uicontrol('style', 'checkbox',       'position', [10 -15+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.ResmCheck', 'callback', 'ResultManagerFunctions(''Rst.ResmCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
...
Rst.cStatCheck          	      = uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset 165+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cStatCheck', 'callback', 'ResultManagerFunctions(''Rst.cStatCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cStanCheck         	         = uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset 145+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cStanCheck', 'callback', 'ResultManagerFunctions(''Rst.cStanCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cObsvCheck           	      = uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset 125+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cObsvCheck', 'callback', 'ResultManagerFunctions(''Rst.cObsvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cModvCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset 105+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cModvCheck', 'callback', 'ResultManagerFunctions(''Rst.cModvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cResvCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset  85+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cResvCheck', 'callback', 'ResultManagerFunctions(''Rst.cResvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cRotvCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset  65+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cRotvCheck', 'callback', 'ResultManagerFunctions(''Rst.cRotvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cDefvCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset  45+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cDefvCheck', 'callback', 'ResultManagerFunctions(''Rst.cDefvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cStrvCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset  25+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cStrvCheck', 'callback', 'ResultManagerFunctions(''Rst.cStrvCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cTrivCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset   5+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cTrivCheck', 'callback', 'ResultManagerFunctions(''Rst.cTrivCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
Rst.cResmCheck                  	= uicontrol('style', 'checkbox',       'position', [ 0+compareXOffset -15+stYOffset 20 20],    'visible', 'on', 'tag', 'Rst.cResmCheck', 'callback', 'ResultManagerFunctions(''Rst.cResmCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off');
...
resimpYOffset = 460;
Rst.ResidImpCheck						= uicontrol    ('style', 'checkbox', 'position', [10 20+resimpYOffset 20 20],    'visible', 'on', 'tag', 'Rst.ResidImpCheck', 'callback', 'ResultManagerFunctions(''Rst.ResidImpCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.SlipNumCheck						= uicontrol('style', 'checkbox', 'position', [10 srYOffset+115 20 20],    'visible', 'on', 'tag', 'Rst.SlipNumCheck', 'callback', 'ResultManagerFunctions(''Rst.SlipNumCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.SlipNumComp						= uibuttongroup('units', 'pixels', 'position', [30 srYOffset+75 20 40], 'tag', 'Rst.SlipNumComp', 'SelectionChangeFcn', @SlipNumComp, 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'bordertype', 'none'); 
...
Rst.SlipColCheck						= uicontrol('style', 'checkbox', 'position', [10 srYOffset+45 20 20],    'visible', 'on', 'tag', 'Rst.SlipColCheck', 'callback', 'ResultManagerFunctions(''Rst.SlipColCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.SlipColComp						= uibuttongroup('units', 'pixels', 'position', [20 srYOffset+5 20 40], 'tag', 'Rst.SlipColComp', 'SelectionChangeFcn', @SlipColComp,'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'bordertype', 'none'); 
...
Rst.cSlipNumCheck						= uicontrol('style', 'checkbox', 'position',   [compareXOffset+0  srYOffset+115 20 20],    'visible', 'on', 'tag', 'Rst.cSlipNumCheck', 'callback', 'ResultManagerFunctions(''Rst.cSlipNumCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.cSlipNumComp						= uibuttongroup('units', 'pixels', 'position', [compareXOffset+20 srYOffset+75 20 40], 'tag', 'Rst.cSlipNumComp', 'SelectionChangeFcn', @cSlipNumComp, 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'bordertype', 'none'); 
...
Rst.cSlipColCheck						= uicontrol('style', 'checkbox', 'position',   [compareXOffset+0  srYOffset+45 20 20],    'visible', 'on', 'tag', 'Rst.cSlipColCheck', 'callback', 'ResultManagerFunctions(''Rst.cSlipColCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.cSlipColComp						= uibuttongroup('units', 'pixels', 'position', [compareXOffset+20 srYOffset+5 20 40], 'tag', 'Rst.cSlipColComp', 'SelectionChangeFcn', @cSlipColComp,'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'bordertype', 'none'); 
...
Rst.StrainCheck						= uicontrol('style', 'checkbox', 'position', [10 opYOffset+65 20 20],    'visible', 'on', 'tag', 'Rst.StrainCheck', 'callback', 'ResultManagerFunctions(''Rst.StrainCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.TriCheck							= uicontrol('style', 'checkbox', 'position', [10 opYOffset+45 20 20],    'visible', 'on', 'tag', 'Rst.TriCheck', 'callback', 'ResultManagerFunctions(''Rst.TriCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.CompTri								= uibuttongroup('units', 'pixels', 'position', [30 opYOffset+5 20 40], 'tag', 'Rst.CompTri', 'SelectionChangeFcn', @CompTri,'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'bordertype', 'none'); 
...
Rst.cStrainCheck						= uicontrol('style', 'checkbox', 'position', [compareXOffset+0 opYOffset+65 20 20],    'visible', 'on', 'tag', 'Rst.cStrainCheck', 'callback', 'ResultManagerFunctions(''Rst.cStrainCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.cTriCheck							= uicontrol('style', 'checkbox', 'position', [compareXOffset+0 opYOffset+45 20 20],    'visible', 'on', 'tag', 'Rst.cTriCheck', 'callback', 'ResultManagerFunctions(''Rst.cTriCheck'')', 'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'enable', 'off'); 
...
Rst.cCompTri							= uibuttongroup('units', 'pixels', 'position', [compareXOffset+20 opYOffset+5 20 40], 'tag', 'Rst.cCompTri', 'SelectionChangeFcn', @cCompTri,'BackgroundColor', lightGrey, 'FontName', fn, 'FontSize', fs, 'bordertype', 'none'); 
...
Rst.axHandle                     = axes('parent', gcf, 'units', 'pixels', 'position', [360 100 1000 700],     'visible', 'on', 'Tag', 'Rst.axHandle', 'Layer', 'top', 'xlim', [0 360], 'ylim', [-90 90], 'FontName', fn);
