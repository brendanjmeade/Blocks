...
cd smoothtests
exptest = [0.5:0.5:2];
smooth1 = [0.05:0.1:0.35];
smooth2 = [0.05:0.05:0.2];
smooth3 = [1:5];
[exptest, smooth1, smooth2, smooth3] = ndgrid(exptest, smooth1, smooth2, smooth3);
total = numel(exptest);
iter = 163;
for i = 163:numel(exptest)

disp(sprintf('Iteration %g of %g\n\n', iter, total));
Command.triSmooth = [smooth1(i) smooth2(i) smooth3(i)];
Command.pmagTriSmooth = exptest(i);
