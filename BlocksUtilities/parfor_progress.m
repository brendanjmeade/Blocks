...
%   PARFOR_PROGRESS works by creating a file called parfor_progress.txt on
%   your desktop, and then keeping track of the parfor loop's
...
%
%   PARFOR_PROGRESS(0) deletes ~/Desktop/parfor_progress.txt and finalizes progress
%   bar.
%
