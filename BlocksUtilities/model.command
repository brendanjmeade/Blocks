Segment file name: ../segment/model.segment
Station file name: ../station/model.sta
Sar file name: 
Block file name: ../block/model.block
Reuse old elastic kernel: no
Old elastic kernel file: 
