...
% Write out labels
WriteStation(sprintf('.%s%s%slabel.sta.data', filesep, runName, filesep), Station.lon, Station.lat, zeros(size(Station.lon)), zeros(size(Station.lon)), Station.eastSig, Station.northSig, Station.corr, Station.blockLabel, Station.tog, Station.name);
...
WriteStation(sprintf('.%s%s%sObs.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Station.eastVel, Station.northVel, Station.eastSig, Station.northSig, Station.corr, Station.blockLabel, Station.tog, Station.name);
WriteStation(sprintf('.%s%s%sRes.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Model.eastResidVel, Model.northResidVel, Station.eastSig, Station.northSig, Station.corr, Station.blockLabel, Station.tog, Station.name);
WriteStation(sprintf('.%s%s%sMod.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Model.eastVel, Model.northVel, zeros(size(Station.eastSig)), zeros(size(Station.northSig)), Station.corr, Station.blockLabel, Station.tog, Station.name);
WriteStation(sprintf('.%s%s%sRot.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Model.eastRotVel, Model.northRotVel, zeros(size(Station.eastSig)), zeros(size(Station.northSig)), Station.corr, Station.blockLabel, Station.tog, Station.name);
WriteStation(sprintf('.%s%s%sDef.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Model.eastDefVel, Model.northDefVel, zeros(size(Station.eastSig)), zeros(size(Station.northSig)), Station.corr, Station.blockLabel, Station.tog, Station.name);
WriteStation(sprintf('.%s%s%sTri.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Model.eastTriVel, Model.northTriVel, zeros(size(Station.eastSig)), zeros(size(Station.northSig)), Station.corr, Station.blockLabel, Station.tog, Station.name);
WriteStation(sprintf('.%s%s%sStrain.sta.data', filesep, runName, filesep), Station.lon, Station.lat, Model.eastStrainVel, Model.northStrainVel, zeros(size(Station.eastSig)), zeros(size(Station.northSig)), Station.corr, Station.blockLabel, Station.tog, Station.name);
