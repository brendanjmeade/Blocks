...
% C1 and C2 specify the colors of the positive and negative axes, respectively, and
% can be any acceptable Matlab color.
%
% BlockStrainAxes(Block,...) accepts
% a pre-loaded Block structure as its first input.
