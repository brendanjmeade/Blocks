...
Segment.other1       = [Segment.other1 ; 0];
Segment.other2       = [Segment.other2 ; 0];
Segment.other3       = [Segment.other3 ; 0];

Segment.other4       = [Segment.other4 ; 0];
Segment.other5       = [Segment.other5 ; 0];
...
Segment.patchName    = strvcat(Segment.patchName, ' ');
Segment.patchFlag01  = [Segment.patchFlag01 ; 0];
Segment.patchFlag02  = [Segment.patchFlag02 ; 0];
